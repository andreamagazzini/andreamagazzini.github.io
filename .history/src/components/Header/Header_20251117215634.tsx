  ...
  return (
    ...
    >
      <HashLink smooth to="#home" className="hover:opacity-80 transition-opacity">
        <div className="h-8 lg:h-8 overflow-hidden">
          <img 
            className="h-[500%] w-auto object-cover object-center" 
            src="/logo.png" 
            alt="Andrea Magazzini logo"
            style={{
              filter: 'brightness(0) saturate(100%) invert(67%) sepia(95%) saturate(1352%) hue-rotate(100deg) brightness(98%) contrast(85%)',
