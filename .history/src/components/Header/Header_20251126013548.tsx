...
export const Header = () => {
  ...
  return (
    <motion.header 
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="flex items-center justify-between px-5 py-3 lg:px-40 lg:py-3 fixed top-0 left-0 w-screen bg-white/90 dark:bg-gray-900/90 backdrop-blur-md z-50 shadow-sm"
    >
      ...
      <nav className="flex items-center gap-4 lg:gap-6">
        <Popover body={personal.email} position="bottom">
        ...
        <a
          ...
          rel="noreferrer"
          aria-label="WhatsApp"
          className="flex items-center justify-center p-2 text-gray-700 dark:text-gray-300 hover:text-green-500 transition-colors"
        >
        ...
        <a
          ...
          className="flex items-center justify-center p-2 text-gray-700 dark:text-gray-300 hover:text-accent-500 transition-colors"
        >
          {theme === 'dark' ? (
        ...
        <a
          ...
          className="flex items-center justify-center p-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
        >
          {theme === 'dark' ? (
        ...
        <a
          ...
          rel="noreferrer"
          aria-label="Telegram"
          className="flex items-center justify-center p-2 text-gray-700 dark:text-gray-300 hover:text-accent-400 transition-colors"
        >
