  ...
  return (
    ...
    >
      <HashLink smooth to="#home" className="hover:opacity-80 transition-opacity">
        <div className="relative flex items-center justify-center overflow-visible" style={{ width: '3rem', height: '3rem' }}>
          ...
          {/* Logo pillola - doppio del diametro del cerchio (3rem * 2 = 6rem) */}
          <img 
